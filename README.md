...
| `RopewikiVehicleType` | N/A | Vehicle requirement for a canyon page (passenger, highClearance, fourWd, etc.). | `import { RopewikiVehicleType } from 'ropegeo-common/models'` |
